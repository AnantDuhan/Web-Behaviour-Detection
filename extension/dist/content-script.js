...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"content/common.js":[function(require,module,exports) {
"use strict";
...
exports.extractElementText = extractElementText;
exports.scoredTextsValueAtt = exports.scoredTextsRankAtt = exports.scoredTextsClassName = void 0;
// html persistence constants
const scoredTextsClassName = 'negativityText';
exports.scoredTextsClassName = scoredTextsClassName;
const scoredTextsValueAtt = 'data-negativity-value';
exports.scoredTextsValueAtt = scoredTextsValueAtt;
const scoredTextsRankAtt = 'data-negativity-rank';
/*
 * text functions
 */

exports.scoredTextsRankAtt = scoredTextsRankAtt;
...
function extractElementText(el) {
  let text = el.text; // text node text

  text = text || [...el.childNodes].filter(el => el.nodeType === Node.TEXT_NODE).map(el => el.textContent).join(""); // handle img tags

  text = text || `${el.getAttribute('alt') || ''}`; // handle a tags
...
},{}],"../node_modules/sentiment/lib/tokenize.js":[function(require,module,exports) {
...
},{}],"../node_modules/sentiment/build/emoji.json":[function(require,module,exports) {
module.exports = {
  "😂": 1,
  "❤": 3,
  "♥": 3,
...
},{}],"../node_modules/sentiment/languages/en/labels.json":[function(require,module,exports) {
module.exports = {
  "abandon": -2,
  "abandoned": -2,
  "abandons": -2,
...
},{}],"../node_modules/sentiment/languages/en/negators.json":[function(require,module,exports) {
module.exports = {
  "cant": 1,
  "can't": 1,
  "dont": 1,
...
},{}],"../node_modules/sentiment/languages/en/scoring-strategy.js":[function(require,module,exports) {
...
},{"./negators.json":"../node_modules/sentiment/languages/en/negators.json"}],"../node_modules/sentiment/languages/en/index.js":[function(require,module,exports) {
module.exports = {
  labels: require('./labels.json'),
  scoringStrategy: require('./scoring-strategy')
};
},{"./labels.json":"../node_modules/sentiment/languages/en/labels.json","./scoring-strategy":"../node_modules/sentiment/languages/en/scoring-strategy.js"}],"../node_modules/sentiment/lib/language-processor.js":[function(require,module,exports) {
...
},{"../build/emoji.json":"../node_modules/sentiment/build/emoji.json","../languages/en/index":"../node_modules/sentiment/languages/en/index.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{}],"../node_modules/sentiment/lib/index.js":[function(require,module,exports) {
...
},{"./tokenize":"../node_modules/sentiment/lib/tokenize.js","./language-processor":"../node_modules/sentiment/lib/language-processor.js","process":"../node_modules/process/browser.js"}],"../node_modules/vader-sentiment/src/vader_lexicon.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/vader-sentiment/src/vaderSentiment.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.scalar_inc_dec = exports.normalize = exports.negated = exports.is_upper_python = exports.allcap_differential = exports.SentimentIntensityAnalyzer = exports.SentiText = exports.SPECIAL_CASE_IDIOMS = exports.REGEX_REMOVE_PUNCTUATION = exports.PUNC_LIST = exports.N_SCALAR = exports.NEGATE = exports.C_INCR = exports.B_INCR = exports.B_DECR = exports.BOOSTER_DICT = void 0;
...
*/
// Constants
const LEXICON = require('./vader_lexicon.js').lexicon; // (empirically derived mean sentiment intensity rating increase for booster words)


const B_INCR = 0.293;
exports.B_INCR = B_INCR;
const B_DECR = -0.293; // (empirically derived mean sentiment intensity rating increase for using
...
const REGEX_REMOVE_PUNCTUATION = new RegExp(/[!"#$%&'()*+,-./:;<=>?@[\\\]^_`{|}~]/g); // ` // <- to fix ide thinking grave accent in regex is starting a template quote

exports.REGEX_REMOVE_PUNCTUATION = REGEX_REMOVE_PUNCTUATION;
const PUNC_LIST = ['.', '!', '?', ',', ';', ':', '-', "'", '"', '!!', '!!!', '??', '???', '?!?', '!?!', '?!?!', '!?!?'];
exports.PUNC_LIST = PUNC_LIST;
const NEGATE = ['aint', 'arent', 'cannot', 'cant', 'couldnt', 'darent', 'didnt', 'doesnt', "ain't", "aren't", "can't", "couldn't", "daren't", "didn't", "doesn't", 'dont', 'hadnt', 'hasnt', 'havent', 'isnt', 'mightnt', 'mustnt', 'neither', "don't", "hadn't", "hasn't", "haven't", "isn't", "mightn't", "mustn't", 'neednt', "needn't", 'never', 'none', 'nope', 'nor', 'not', 'nothing', 'nowhere', 'oughtnt', 'shant', 'shouldnt', 'uhuh', 'wasnt', 'werent', "oughtn't", "shan't", "shouldn't", 'uh-uh', "wasn't", "weren't", 'without', 'wont', 'wouldnt', "won't", "wouldn't", 'rarely', 'seldom', 'despite']; // booster/dampener 'intensifiers' or 'degree adverbs'
...
class SentiText {
  ...
  */
  constructor(text) {
    this.text = text;
    this.words_and_emoticons = this.get_words_and_emoticons(); // doesn't separate words from adjacent punctuation (keeps emoticons & contractions)
  ...
  get_words_plus_punc() {
    ...
    const words = no_punc_text.split(/\s/); // removes singletons
  ...
  */
  static polarity_scores(text) {
    ...
    */
    ...
    for (let i = 0; i < words_and_emoticons.length; i++) {
      ...
      if (i < words_and_emoticons.length - 1 && item.toLowerCase() === 'kind' && words_and_emoticons[i + 1].toLowerCase() === 'of' || BOOSTER_DICT.hasOwnProperty(item.toLowerCase())) {
        sentiments.push(valence);
        continue;
      }

      sentiments = SentimentIntensityAnalyzer.sentiment_valence(valence, sentiText, item, i, sentiments);
    }
  ...
  static sentiment_valence(valence, sentiText, item, index, sentiments) {
    ...
    if (LEXICON.hasOwnProperty(item_lowercase)) {
      ...
      valence = LEXICON[item_lowercase]; // check if sentiment laden word is in ALL CAPS (while others aren't)
      ...
      for (let start_i = 0; start_i < 3; start_i++) {
        if (index > start_i && LEXICON.hasOwnProperty(words_and_emoticons[index - (start_i + 1)].toLowerCase()) === false) {
  ...
  static least_check(valence, words_and_emoticons, index) {
    ...
    */
    if (index > 1 && words_and_emoticons[index - 1].toLowerCase() === 'least' && LEXICON.hasOwnProperty(words_and_emoticons[index - 1].toLowerCase()) === false) {
      if (words_and_emoticons[index - 2].toLowerCase() !== 'at' && words_and_emoticons[index - 2].toLowerCase() !== 'very') {
        valence = valence * N_SCALAR;
      }
    } else if (index > 0 && words_and_emoticons[index - 1].toLowerCase() === 'least' && LEXICON.hasOwnProperty(words_and_emoticons[index - 1].toLowerCase()) === false) {
      valence = valence * N_SCALAR;
    }
  ...
  static idioms_check(valence, words_and_emoticons, index) {
    ...
    const twoonezero = `${words_and_emoticons[index - 2]} ${words_and_emoticons[index - 1]} ${words_and_emoticons[index]}`;
    const twoone = `${words_and_emoticons[index - 2]} ${words_and_emoticons[index - 1]}`;
    const threetwoone = `${words_and_emoticons[index - 3]} ${words_and_emoticons[index - 2]} ${words_and_emoticons[index - 1]}`;
    ...
    if (words_and_emoticons.length - 1 > index + 1) {
      const zeroonetwo = `${words_and_emoticons[index]} ${words_and_emoticons[index + 1]} ${words_and_emoticons[index + 2]}`;
  ...
  static never_check(valence, words_and_emoticons, start_i, index) {
    ...
    if (start_i === 1) {
      if (words_and_emoticons[index - 2] === 'never' && (words_and_emoticons[index - 1] === 'so' || words_and_emoticons[index - 1] === 'this')) {
        valence = valence * 1.5;
    ...
    if (start_i === 2) {
      if (words_and_emoticons[index - 3] === 'never' && (words_and_emoticons[index - 2] === 'so' || words_and_emoticons[index - 2] === 'this') || words_and_emoticons[index - 1] === 'so' || words_and_emoticons[index - 1] === 'this') {
  ...
  static score_valence(sentiments, text) {
    if (sentiments && sentiments.length > 0) {
      ...
      let compound = normalize(sum_s); // discriminate between positive, negative and neutral sentiment scores
...
},{"./vader_lexicon.js":"../node_modules/vader-sentiment/src/vader_lexicon.js"}],"content/backends.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PythonBackendNegativity = exports.JSNegativityVader = exports.JSNegativityAFINN = void 0;

var _sentiment = _interopRequireDefault(require("sentiment"));

var _vaderSentiment = require("vader-sentiment/src/vaderSentiment.js");

var _vader_lexicon = require("vader-sentiment/src/vader_lexicon.js");
...
class BackendBase {
  ...
  static collectTexts_(elements) {
    return [...elements].map(el => (0, _common.extractElementText)(el));
  }
...
class JSNegativityAFINN extends BackendBase {
  static sentimentLib = new _sentiment.default();
  static extraLexicon = {
    'trump': -2,
    'covid': -2,
    'coronavirus': -2,
  ...
  static async processElements(elements, chunkCallback) {
    ...
    const values = texts.map(text => {
      const result = this.sentimentLib.analyze(text, this.extraLexicon); // return -1 * result.comparative; 
...
exports.JSNegativityAFINN = JSNegativityAFINN;
...
class JSNegativityVader extends BackendBase {
  ...
  static lazyLexiconUpdate() {
    if (!this.lexiconUpdated) {
      Object.assign(_vader_lexicon.lexicon, this.extraLexicon);
  ...
  static async processElements(elements, chunkCallback) {
    ...
    const texts = this.collectTexts_(elements);
    const values = texts.map(text => {
      const result = _vaderSentiment.SentimentIntensityAnalyzer.polarity_scores(text); // return (0.5 - 0.5 * result.compound); // compound score is in [-1, 1] range
      ...
      if (!scoreNorm) {
        ...
        return clip(0.5 + centeredScore / (scoreNorm + neutNorm)); // neg / neu / pos raw fields that are
...
exports.JSNegativityVader = JSNegativityVader;
  ...
  static async singleCallPromise_(elements) {
    try {
      const response = await fetch(this.address, {
        method: 'post',
        body: JSON.stringify({
          texts: this.collectTexts_(elements)
        })
      });
      ...
      if (!document.hidden) {
        // only do this for active tab
        const instructionsLocation = 'https://github.com/anantduhan/web-behaviour-detection/python-backend.md';
        const confirmPrompt = 'Web-Behaviour-Detection extension: local backend call failed.\n\n' + 'Please switch to another scoring option, ' + 'or ensure that a local scoring service is running.' + '\n\nPress "Cancel" to do nothing, or "OK" to open instructions page in a new tab.';
...
exports.PythonBackendNegativity = PythonBackendNegativity;
},{"sentiment":"../node_modules/sentiment/lib/index.js","vader-sentiment/src/vaderSentiment.js":"../node_modules/vader-sentiment/src/vaderSentiment.js","vader-sentiment/src/vader_lexicon.js":"../node_modules/vader-sentiment/src/vader_lexicon.js","./common.js":"content/common.js"}],"content/scoring.js":[function(require,module,exports) {
"use strict";
...
exports.NegativityScorer = NegativityScorer;
},{"./common.js":"content/common.js","../settings.js":"settings.js","./backends.js":"content/backends.js"}],"content/restyling.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Restyler = void 0;
...
class Restyler {
  ...
  static maxCombine = 3;
  static scoredTextsSelector = `.${_common.scoredTextsClassName}`; // state
  ...
  static findAndRestyleAll_() {
    const scoreAttr = this.settings_.ranking ? _common.scoredTextsRankAtt : _common.scoredTextsValueAtt;
    const restyled = new Set();
    const visitedChildren = new Set(); // restyle parents

    if (!this.settings_.onlyTexts) {
      const allParents = document.querySelectorAll(`${this.containerSelector} > ${this.scoredTextsSelector}`); // order is assumed to be topological (top to bottom of tree)
      // so that higher parents have precedence over lower ones

      allParents.forEach(parent => {
        const children = [...parent.querySelectorAll(this.scoredTextsSelector)]; // limit number of children that can be combined

        if (children.length == 0 || children.length > this.maxCombine) return; // stop if some are visited

        if (children.some(el => visitedChildren.has(el))) return;
        const scores = children.map(el => parseFloat(el.getAttribute(scoreAttr)));
        const numNegs = scores.filter(val => val > this.settings_.threshold).length; // only if all negatives or all positives (or only one child)
  ...
  static restoreRestyledPreviosly() {
    [...this.restyledPreviously_].forEach(el => this.resetElementStyle_(el)); // console.log(`restored ${this.restyledPreviously_.size} elements`);
...
exports.Restyler = Restyler;
},{"./common.js":"content/common.js","../settings.js":"settings.js"}],"content/main.js":[function(require,module,exports) {
"use strict";
...
var _restyling = require("./restyling.js");

function calulationsCallback() {
  _restyling.Restyler.updateAll();

  chrome.runtime.sendMessage({
    type: 'statsUpdate',
    stats: _scoring.NegativityScorer.stats
  });
...
function addMutationObserverWithDelay(delayedCallback) {
  ...
  function textElements() {
    return _scoring.NegativityScorer.qualifiedTextElements([...changeTimes.keys()]);
  }
...
function main() {
  // initial run
  _scoring.NegativityScorer.updateAll(calulationsCallback);

  let oldSettings; // watch for option changes

  chrome.storage.onChanged.addListener(changes => {
    if ('storedSettings' in changes) {
      const newStoredSettings = changes.storedSettings.newValue;
      const newSettings = newStoredSettings[(0, _common.domain)()] || newStoredSettings.global;
      const recalcNeeded = !oldSettings || newSettings.backend != oldSettings.backend || newSettings.enabled != oldSettings.enabled;
  ...
  addMutationObserverWithDelay(() => _scoring.NegativityScorer.updateAll(calulationsCallback));
}

main();
},{"./common.js":"content/common.js","./scoring.js":"content/scoring.js","./restyling.js":"content/restyling.js"}],"content-script.js":[function(require,module,exports) {
"use strict";

require("./content/main.js");
},{"./content/main.js":"content/main.js"}]},{},["content-script.js"], null)
